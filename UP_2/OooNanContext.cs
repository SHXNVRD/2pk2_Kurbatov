...
public partial class OooNanContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-JT57IK1E\\SQLEXPRESS; Initial Catalog=OOO_NAN; Integrated Security=True; Trusted_Connection=True; TrustServerCertificate=True;");
